...
public class Weight extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * Above parameter determines whether user wishes to select another
		 * product, add the current order to the cart, remove an existing order
		 * from the cart or proceed to the checkout. User is redirected to the
		 * appropriate page (after any required updating of the shopping cart
		 * session variable has been carried out).
		 */
